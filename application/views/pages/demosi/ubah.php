 ...
 <div class="content-header">
     <div class="container-fluid">
         <div class="row mb-2">
             <div class="col-sm-6">
                 <h1 class="m-0">Ubah Data Demosi</h1>
             </div><!-- /.col -->
             <div class="col-sm-6">
                 <ol class="breadcrumb float-sm-right">
                     <li class="breadcrumb-item"><a href="#"><i class="fas fa-file"></i> Data Demosi</a></li>
                     <li class="breadcrumb-item active"> Ubah Data Demosi</li>
                 </ol>
             </div><!-- /.col -->
         </div><!-- /.row -->
     </div><!-- /.container-fluid -->
             ...
             <div class="col-12">
                 <div class="card card-outline card-primary">
                     <div class="card-header">
                         <h3 class="card-title mt-2">Form Ubah Data Demosi</h3>
                     </div>
                     <!-- /.card-header -->
                     <?= form_open(); ?>
                     <div class="card-body">
                         <input type="hidden" class="form-control" name="id_demosi" id="id_demosi" value="<?= $demosi->id_demosi; ?>">
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <select class="form-control theSelect" name="id_pegawai" id="id_pegawai">
                                     <option value="<?= $demosi->id_pegawai; ?>"><?= $demosi->nip; ?> | <?= $demosi->nama; ?></option>
                                 </select>
                             </div>
                         </div>
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <select class="form-control theSelect" name="divisi_sebelum" id="divisi_sebelum">
                                     <option value="<?= $demosi->divisi_sebelum; ?>"><?= $demosi->divisi_sebelum; ?></option>
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <select class="form-control theSelect" name="jabatan_sebelum" id="jabatan_sebelum">
                                     <option value="<?= $demosi->jabatan_sebelum; ?>"><?= $demosi->jabatan_sebelum; ?></option>
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <select class="form-control theSelect" name="divisi_sesudah" id="divisi_sesudah">
                                     <option value="<?= $demosi->divisi_sesudah; ?>"><?= $demosi->divisi_sesudah; ?></option>
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <div class="input-group">
                                     ...
                                     <input type="date" class="form-control <?= form_error('tanggal_sk') ? 'is-invalid' : ''; ?>" value="<?= (set_value('tanggal_sk') ? set_value('tanggal_sk') : $demosi->tanggal_sk); ?>" name="tanggal_sk" id="tanggal_sk">
                                 </div>
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <input type="text" class="form-control" name="nomor_sk" id="nomor_sk" value="<?= $demosi->nomor_sk; ?>">
                             </div>
                         </div>
                     </div>
                     <!-- /.card-body -->

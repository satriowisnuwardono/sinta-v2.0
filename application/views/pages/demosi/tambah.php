 ...
 <div class="content-header">
     <div class="container-fluid">
         <div class="row mb-2">
             <div class="col-sm-6">
                 <h1 class="m-0">Tambah Data Demosi</h1>
             </div><!-- /.col -->
             <div class="col-sm-6">
                 <ol class="breadcrumb float-sm-right">
                     <li class="breadcrumb-item"><a href="#"><i class="fas fa-file"></i> Data Demosi</a></li>
                     <li class="breadcrumb-item active"> Tambah Data Demosi</li>
                 </ol>
             </div><!-- /.col -->
         </div><!-- /.row -->
     </div><!-- /.container-fluid -->
             ...
             <div class="col-12">
                 <div class="card card-outline card-primary">
                     <div class="card-header">
                         <h3 class="card-title mt-2">Form Tambah Data Demosi</h3>
                     </div>
                     <!-- /.card-header -->
                     <?= form_open('demosi/tambah'); ?>
                     <div class="card-body">

 ...
 <div class="content-header">
     <div class="container-fluid">
         <div class="row mb-2">
             <div class="col-sm-6">
                 <h1 class="m-0">Ubah Data Mutasi</h1>
             </div><!-- /.col -->
             <div class="col-sm-6">
                 <ol class="breadcrumb float-sm-right">
                     <li class="breadcrumb-item"><a href="#"><i class="fas fa-file"></i> Data Mutasi</a></li>
             ...
             <div class="col-12">
                 <div class="card card-outline card-primary">
                     <div class="card-header">
                         <h3 class="card-title mt-2">Form Ubah Data Mutasi</h3>
                     </div>
                     <!-- /.card-header -->
                     <?= form_open(); ?>
                     <div class="card-body">
                         <input type="hidden" class="form-control" name="id_mutasi" id="id_mutasi" value="<?= $mutasi->id_mutasi; ?>">
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <select class="form-control theSelect" name="id_pegawai" id="id_pegawai">
                                     <option value="<?= $mutasi->id_pegawai; ?>"><?= $mutasi->nip; ?> | <?= $mutasi->nama; ?></option>
                                 </select>
                             </div>
                         </div>
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <select class="form-control theSelect" name="divisi_sebelum" id="divisi_sebelum">
                                     <option value="<?= $mutasi->divisi_sebelum; ?>"><?= $mutasi->divisi_sebelum; ?></option>
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <select class="form-control theSelect" name="jabatan_sebelum" id="jabatan_sebelum">
                                     <option value="<?= $mutasi->jabatan_sebelum; ?>"><?= $mutasi->jabatan_sebelum; ?></option>
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <select class="form-control theSelect" name="divisi_sesudah" id="divisi_sesudah">
                                     <option value="<?= $mutasi->divisi_sesudah; ?>"><?= $mutasi->divisi_sesudah; ?></option>
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <div class="input-group">
                                     ...
                                     <input type="date" class="form-control <?= form_error('tanggal_sk') ? 'is-invalid' : ''; ?>" value="<?= (set_value('tanggal_sk') ? set_value('tanggal_sk') : $mutasi->tanggal_sk); ?>" name="tanggal_sk" id="tanggal_sk">
                                 </div>
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <input type="text" class="form-control" name="nomor_sk" id="nomor_sk" value="<?= $mutasi->nomor_sk; ?>">
                             </div>
                         </div>
                     </div>
                     <!-- /.card-body -->

                 ...
                 <div class="card card-outline card-primary">
                     ...
                     <div class="card-body">
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <input type="text" name="masa_berlaku" id="amasa_berlaku" class="form-control">
                             </div>
                         </div>
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <div class="input-group">
                                     ...
                                     <input type="date" class="form-control <?= form_error('tanggal_mulai') ? 'is-invalid' : ''; ?>" value="<?= set_value('tanggal_mulai'); ?>" name="tanggal_mulai" id="tanggal_mulai">
                                 </div>
